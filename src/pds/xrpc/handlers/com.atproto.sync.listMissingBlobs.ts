// XRPC handler: com.atproto.sync.listMissingBlobs
//
// Lexicon: https://github.com/bluesky-social/atproto/blob/main/lexicons/com/atproto/sync/listMissingBlobs.json
//
...
export const nsid = 'com.atproto.sync.listMissingBlobs'
